...
namespace LexiconLMS.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            public Boolean AddStudentForCourse { get; set; }  //
        }

        public PageResult OnGet(int? CourseId, string returnUrl = null, Boolean addStudentForCourse=false)

        {
            ...
            Input.AddStudentForCourse = addStudentForCourse;
            ...
            if ((CourseId > 0) && (addStudentForCourse))
            {
        ...
        public async Task<IActionResult> OnPostAsync( string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var resultAddRole = await _userManager.AddToRoleAsync(user, Input.Role);
                    if ((Input.CourseId > 0) && (Input.AddStudentForCourse))
                    {
                        //Blir förvalda i registrerings vyn och visas ej
