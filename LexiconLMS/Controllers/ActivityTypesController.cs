...
namespace LexiconLMS.Controllers
{
    ...
    public class ActivityTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Type")] ActivityType activityType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Type")] ActivityType activityType)
        {
